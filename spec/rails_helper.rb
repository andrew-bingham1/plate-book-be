...
def test_data_hot
  ...
  @comment_6 = @post_18.comments.create!(body: "Comment 6", user_id: @user_2.id)
  @comment_7 = @post_19.comments.create!(body: "Comment 7", user_id: @user_2.id)
  @comment_8 = @post_20.comments.create!(body: "Comment 8", user_id: @user_2.id)
